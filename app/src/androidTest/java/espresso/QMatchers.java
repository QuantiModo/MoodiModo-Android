...
public class QMatchers {
    ...
    public static Matcher<Object> withChildName(final String name){
    ...
    public static Matcher<Object> withChildName(final Matcher<String> name) {
        ...
        return new BoundedMatcher<Object, DrawerAdapter.DrawerItem>(DrawerAdapter.DrawerItem.class){

            @Override
            public boolean matchesSafely (final DrawerAdapter.DrawerItem childStruct){
                return name.matches(childStruct.getName());
            }
